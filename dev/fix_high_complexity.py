...
def fix_high_complexity_functions():
    ...
    high_complexity_functions = [
        ...
        ('intellicrack/core/analysis/binary_similarity_search.py', 113, '_extract_binary_features'),
        ...
        ('intellicrack/core/analysis/core_analysis.py', 85, 'analyze_binary_internal'),
        ('intellicrack/core/analysis/core_analysis.py', 232, 'enhanced_deep_license_analysis'),
        ('intellicrack/core/analysis/core_analysis.py', 335, 'detect_packing'),
        ('intellicrack/core/analysis/core_analysis.py', 461, 'decrypt_embedded_script'),
        ('intellicrack/core/analysis/dynamic_analyzer.py', 119, '_frida_runtime_analysis'),
    ...
    for file_path, line_num, func_name in high_complexity_functions[:50]:  # Process first 50
