...
class AnalysisCLI:
    ...
    def _find_interesting_strings(self, strings: List[str]) -> List[str]:
        ...
        interesting_patterns = [
            ...
            "patch", "keygen", "http://", "https://", ".exe",
            ".dll", "SELECT", "INSERT", "UPDATE", "DELETE",
            "cmd.exe", "powershell", "reg.exe", "admin",
            "root", "sudo", "token", "api_key", "secret"
        ]
...
def main():
    ...
    parser.add_argument(
        "target",
        help="Path to binary file or directory to analyze"
    )
    ...
    parser.add_argument(
        "--no-binary-analysis",
        action="store_true",
        help="Skip binary analysis"
    )

    parser.add_argument(
        "--no-protection-analysis",
        action="store_true",
        help="Skip protection analysis"
    )
    ...
    parser.add_argument(
        "--no-pe-analysis",
        action="store_true",
        help="Skip PE-specific analysis"
    )

    parser.add_argument(
        "--no-elf-analysis",
        action="store_true",
        help="Skip ELF-specific analysis"
    )
    ...
    parser.add_argument(
        "-r", "--recursive",
        action="store_true",
        help="Recursively analyze files in subdirectories"
    )
