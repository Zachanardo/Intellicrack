...
if (!Java.available) {
    ...
    Java.perform(() => {
        ...
        try {
            ...
            NetworkSecurityTrustManager.checkPins.implementation = pins => {
        ...
        try {
            ...
            WebViewClient.onReceivedSslError.implementation = (view, handler, error) => {
        ...
        try {
            ...
            PinningTrustManager.checkServerTrusted.implementation = (chain, authType) => {
