...
var TimeBombDefuser = {
    ...
    config: {
        ...
        ntpServers: [
            ...
            'time-a.nist.gov', 'time-b.nist.gov', 'time-c.nist.gov'
        ],
    ...
    detectWindowsCapabilities: function() {
        ...
        Process.enumerateModules().forEach(function(module) {
            ...
            if (name.includes('clr.dll') || name.includes('coreclr.dll') || name.includes('mscorlib')) {
    ...
    initializeML: function() {
        ...
        var knownPatterns = [
            ...
            'time()', 'gettimeofday', 'clock_gettime', 'DateTime.Now', 'DateTime.UtcNow'
        ];
        ...
        this.safeHook('kernel32.dll', 'GetLocalTime', {
            ...
            onLeave: function(retval) {
                if (this.lpSystemTime && !this.lpSystemTime.isNull()) {
                    ...
                    var localTime = new Date(spoofedTime.getTime() - (new Date().getTimezoneOffset() * 60000));
    ...
    hookDotNetDateTime: function() {
        ...
        Process.enumerateModules().forEach(function(module) {
            ...
            if (moduleName.indexOf('clr.dll') !== -1 ||
    ...
    hookNetworkTime: function() {
        ...
        this.safeHook(Module.findExportByName('ws2_32.dll', 'getaddrinfo'), 'NetworkTime_GetAddrInfo', function(args) {
            return {
                onEnter: function(args) {
        ...
        this.safeHook(Module.findExportByName('ws2_32.dll', 'connect'), 'NetworkTime_Connect', function(args) {
            return {
                onEnter: function(args) {
                    var sockaddr = args[1];
        ...
        this.safeHook(Module.findExportByName('winhttp.dll', 'WinHttpOpen'), 'NetworkTime_WinHttpOpen', function(args) {
            return {
                onEnter: function(args) {
    ...
    hookCertificateValidation: function() {
        ...
        // CertVerifyTimeValidity
        this.safeHook(Module.findExportByName('crypt32.dll', 'CertVerifyTimeValidity'), 'Certificate_VerifyTimeValidity', function(args) {
            return new NativeCallback(function(pTimeToVerify, pCertInfo) {
                send({
                    type: 'bypass',
                    target: 'time_bomb_defuser',
        ...
        this.safeHook(Module.findExportByName('crypt32.dll', 'CertGetCertificateChain'), 'Certificate_GetCertificateChain', function(args) {
            return {
                onEnter: function(args) {
        ...
        this.safeHook(Module.findExportByName('secur32.dll', 'InitializeSecurityContextW'), 'Certificate_InitializeSecurityContext', function(args) {
            return {
                onEnter: function(args) {
    ...
    hookTimezones: function() {
        ...
        this.safeHook(Module.findExportByName('kernel32.dll', 'GetTimeZoneInformation'), 'Timezone_GetTimeZoneInformation', function(args) {
            return {
                onEnter: function(args) {
                    this.tzInfo = args[0];
                },
        ...
        this.safeHook(Module.findExportByName('kernel32.dll', 'GetDynamicTimeZoneInformation'), 'Timezone_GetDynamicTimeZoneInformation', function(args) {
            return {
                onEnter: function(args) {
                    this.tzInfo = args[0];
                },
    ...
    hookCRTTime: function() {
        ...
        if (timeFunc) {
            this.safeHook(timeFunc, 'CRT_Time', function(args) {
                return new NativeCallback(function(timer) {
                    var spoofedTime = self.getSpoofedTime();
                    var unixTime = Math.floor(spoofedTime.getTime() / 1000);
    ...
    setupProcessTracking: function() {
        ...
        this.safeHook(Module.findExportByName('kernel32.dll', 'CreateProcessW'), 'Process_CreateProcessW', function(args) {
            return {
                onEnter: function(args) {
                    if (args[1]) {
