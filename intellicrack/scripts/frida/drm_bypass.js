...
const DrmBypass = {
  ...
  hookHdcpEncryption: function () {
    ...
    var cryptFunctions = ["CryptEncrypt", "CryptDecrypt", "CryptHashData"];
  ...
  hookGeoLocationBypass: function () {
    ...
    var geoFunctions = ["GetGeoInfo", "GetUserGeoID", "GetGeoInfoW"];
  ...
  hookTrustedExecutionEnvironment: function () {
    ...
    var teeFunctions = ["TeeProcCreate", "TeeInvokeCommand", "TeeOpenSession"];
  ...
  hookGenericDecryption: function () {
    ...
    var decryptFunctions = ["CryptDecrypt", "BCryptDecrypt", "NCryptDecrypt"];
  ...
  hookKeyDerivation: function () {
    ...
    // Hook key derivation functions
    var kdfFunctions = ["CryptDeriveKey", "BCryptDeriveKey", "CryptDestroyKey"];
  ...
  hookContentKeyHandling: function () {
    ...
    var keyFunctions = ["CryptExportKey", "CryptImportKey", "CryptGetKeyParam"];
