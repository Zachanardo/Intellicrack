...
from ...ai.background_loader import (
    QueuedProgressCallback, LoadingProgress, LoadingState, LoadingTask
)
...
class ModelLoadingItemWidget(QWidget):
    ...
    def update_progress(self, progress: LoadingProgress):
...
class ModelLoadingProgressWidget(QWidget):
    ...
    def handle_progress_update(self, progress: LoadingProgress):
    ...
    def cancel_loading(self, model_id: str):
