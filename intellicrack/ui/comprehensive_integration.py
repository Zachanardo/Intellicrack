...
from PyQt5.QtWidgets import QWidget, QTabWidget, QMainWindow, QApplication, QMessageBox
...
from .enhanced_ui_integration import EnhancedAnalysisDashboard, EnhancedMainWindow
