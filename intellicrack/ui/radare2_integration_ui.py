...
class R2AnalysisWorker(QThread):
    ...
    def __init__(self, binary_path: str, analysis_type: str, options: dict[str, Any]) -> None:
        ...
        Args:
            ...
            analysis_type: Type of analysis to perform (e.g., 'comprehensive', 'decompilation').
            options: Configuration options for the analysis as a dictionary.
        """
        super().__init__()
    ...
    def run(self) -> None:
        ...
        Raises:
            ValueError: If the analysis type is unknown or invalid.
        """
        try:
    ...
    def _run_comprehensive_analysis(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing comprehensive analysis results from all enabled analysis engines.
        """
    ...
    def _run_decompilation_analysis(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing decompiled functions and pseudocode analysis results.
        """
    ...
    def _run_vulnerability_analysis(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing identified vulnerabilities organized by type and severity.
        """
    ...
    def _run_string_analysis(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing extracted strings categorized by type and relevance to licensing.
        """
    ...
    def _run_import_analysis(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing imported/exported functions and API categories relevant to protection.
        """
    ...
    def _run_cfg_analysis(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing control flow graph metrics and licensing-related patterns.
        """
    ...
    def _run_ai_analysis(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing AI-assisted analysis results for licensing detection and patterns.
        """
    ...
    def _run_bypass_analysis(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing generated bypass techniques and exploitation code for licensing protection.
        """
...
class R2ConfigurationDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        """Set up configuration dialog UI with analysis options, feature toggles, and advanced settings."""
    ...
    def get_configuration(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing all user-selected configuration options for radare2 analysis.
        """
        return {
...
class R2ResultsViewer(QWidget):
    ...
    def _setup_ui(self) -> None:
        """Set up results viewer UI with navigation and display components."""
        layout = QVBoxLayout(self)
    ...
    def display_results(self, results: dict[str, Any]) -> None:
        ...
        Args:
            results: Dictionary containing analysis results from radare2 analysis engines.
        """
    ...
    def _create_component_tab(self, component: str, data: dict[str, Any]) -> None:
        """Create tab for component results with summary and detailed sections.

        Args:
            component: Name of the analysis component (e.g., 'vulnerability', 'strings').
            data: Dictionary containing the analysis results for this component.
        """
        tab_widget = QWidget()
    ...
    def _generate_summary(self, data: dict[str, Any]) -> str:
        ...
        Args:
            data: Dictionary containing component analysis results.

        Returns:
            Formatted string summarizing key metrics and findings from analysis results.
        """
        if "error" in data:
    ...
    def _create_vulnerability_view(self, layout: QVBoxLayout, data: dict[str, Any]) -> None:
        """Create vulnerability-specific view with categorized vulnerability table.

        Args:
            layout: Parent layout to add vulnerability table widget to.
            data: Dictionary containing vulnerability analysis results.
        """
        table = QTableWidget()
    ...
    def _create_strings_view(self, layout: QVBoxLayout, data: dict[str, Any]) -> None:
        """Create strings-specific view with tabbed string categories.

        Args:
            layout: Parent layout to add strings display widget to.
            data: Dictionary containing string analysis results categorized by type.
        """
    ...
    def _create_imports_view(self, layout: QVBoxLayout, data: dict[str, Any]) -> None:
        """Create imports-specific view with tree widgets for imports and API categories.

        Args:
            layout: Parent layout to add imports display widget to.
            data: Dictionary containing imported/exported functions and API categories.
        """
        splitter = QSplitter()
    ...
    def _create_cfg_view(self, layout: QVBoxLayout, data: dict[str, Any]) -> None:
        """Create CFG-specific view with metrics and license pattern tables.

        Args:
            layout: Parent layout to add CFG display widget to.
            data: Dictionary containing control flow graph metrics and patterns.
        """
        # CFG metrics
    ...
    def _create_ai_view(self, layout: QVBoxLayout, data: dict[str, Any]) -> None:
        """Create AI analysis-specific view with license detection and vulnerability prediction.

        Args:
            layout: Parent layout to add AI analysis display widget to.
            data: Dictionary containing AI-assisted analysis results.
        """
        ai_tabs = QTabWidget()
...
Validation Methods: {", ".join(license_data.get("validation_methods", []))}
    ...
    def _create_generic_view(self, layout: QVBoxLayout, data: dict[str, Any]) -> None:
        """Create generic JSON view for arbitrary analysis results.

        Args:
            layout: Parent layout to add JSON display widget to.
            data: Dictionary containing analysis results to display as formatted JSON.
        """
    ...
    def _on_component_changed(self, component: str) -> None:
        """Handle component selection change and switch to corresponding results tab.

        Args:
            component: Name of the selected component to display.
        """
...
class R2IntegrationWidget(QWidget):
    ...
    def set_binary_path(self, path: str) -> None:
        ...
        Args:
            path: File path to the binary to analyze.
        """
    ...
    def _browse_file(self) -> None:
        """Open file browser dialog to select binary file for analysis."""
    ...
    def _configure_analysis(self) -> None:
        """Open configuration dialog to customize analysis parameters."""
    ...
    def _start_analysis(self, analysis_type: str) -> None:
        ...
        Args:
            analysis_type: Type of analysis to run (e.g., 'comprehensive', 'vulnerability').
        """
    ...
    def _on_analysis_completed(self, results: dict[str, Any]) -> None:
        ...
        Args:
            results: Dictionary containing the completed analysis results.
        """
    ...
    def _on_analysis_error(self, error: str) -> None:
        ...
        Args:
            error: Error message from the analysis worker.
        """
        self.status_label.setText(f"Analysis failed: {error}")
        QMessageBox.critical(self, "Analysis Error", f"Analysis failed:\n{error}")

    def _on_analysis_finished(self) -> None:
        """Handle analysis thread finished and restore UI to normal state."""
        for button in self.buttons.values():
...
def create_radare2_tab(parent: QWidget | None = None) -> QWidget:
    ...
    Returns:
        R2IntegrationWidget instance configured as a tab widget for the main application.
    """
...
def integrate_with_main_app(main_app: _MainAppProtocol) -> bool:
    ...
    Args:
        main_app: Main application object implementing _MainAppProtocol with tab_widget and binary_path.
