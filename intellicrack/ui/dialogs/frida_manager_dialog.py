...
class FridaManagerDialog(QDialog):
    ...
    def show_script_context_menu(self, position) -> None:
    ...
    def delete_script(self, item) -> None:
    ...
    def duplicate_script(self, item) -> None:
    ...
    def show_loaded_script_menu(self, position) -> None:
