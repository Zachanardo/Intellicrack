...
from PyQt5.QtWidgets import (
    ...
    QSplitter, QTabWidget, QWidget, QToolBar, QLineEdit,
    QFileDialog, QMessageBox, QListWidgetItem, QMenu
)
from PyQt5.QtCore import Qt, QTimer, pyqtSignal, QThread
from PyQt5.QtGui import QFont, QTextCursor, QTextCharFormat, QTextFormat, QColor, QIcon

from ...tools.plugin_debugger import (
    PluginDebugger, DebuggerThread, BreakpointType, DebuggerState
)
