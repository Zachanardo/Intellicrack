...
class KeygenDialog(BaseDialog):
    ...
    def setup_management_tab(self) -> None:
        ...
        self.existing_keys_input.setToolTip(
            "Enter existing license keys to analyze their patterns and characteristics"
        )
        instruction_label = QLabel(
            "Paste existing license keys (one per line) to analyze patterns and detect key generation algorithms:"
        )
