...
from PyQt5.QtWidgets import (
    ...
    QCheckBox, QTextEdit, QGroupBox, QRadioButton, QButtonGroup
)
...
class QEMUTestDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        # Header with icon and warning        header_layout = QHBoxLayout()
        ...
        if self.script_preview:
            ...
            preview_text.setReadOnly(True)            preview_text.setMaximumHeight(150)
        ...
        qemu_desc = QLabel("    Safe environment to test script behavior before host execution")        qemu_desc.setStyleSheet("color: #888;")
