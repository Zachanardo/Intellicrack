...
try:
    from PyQt5.QtWidgets import (
        ...
        QFormLayout, QProgressBar, QListWidget, QListWidgetItem,
        QSplitter, QFrame
    )
...
try:
    from ...ai.llm_backends import (
        LLMManager, LLMConfig, LLMProvider, get_llm_manager,
        create_openai_config, create_anthropic_config, 
        create_gguf_config, create_ollama_config
    )
