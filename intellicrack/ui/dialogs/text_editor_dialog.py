...
try:
    from PyQt5.QtWidgets import (
        ...
        QFormLayout, QSpinBox, QFontComboBox, QSlider,
        QToolBar, QAction, QStatusBar, QFrame, QPlainTextEdit
    )
    from PyQt5.QtCore import Qt, pyqtSignal, QTimer, QFileSystemWatcher
    from PyQt5.QtGui import (
        QFont, QIcon, QPixmap, QSyntaxHighlighter, QTextCharFormat,
        QColor, QTextDocument, QKeySequence, QTextCursor
    )
    HAS_PYQT = True
except ImportError:
    HAS_PYQT = False
