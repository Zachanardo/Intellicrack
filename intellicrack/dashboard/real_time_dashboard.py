...
class RealTimeDashboard:
    ...
    def __init__(self, config: dict[str, Any] | None = None) -> None:
        ...
        Args:
            config: Dashboard configuration dictionary with optional keys
                including max_events, metrics_history, update_interval,
                metrics_update_interval, enable_websocket, enable_http,
                websocket_port, and http_port. Defaults to empty dict if None.
    ...
    def add_event(self, event: DashboardEvent) -> None:
        ...
        Args:
            event: Dashboard event to add with event_type, timestamp, tool,
                title, description, data, severity, and tags.
    ...
    def register_callback(self, callback: Callable[[DashboardEvent], None]) -> None:
        ...
        Args:
            callback: Function to call on events with signature
                (event: DashboardEvent) -> None.
    ...
    def start_analysis(self, analysis_id: str, tool: str, target: str, options: dict[str, Any] | None = None) -> None:
        ...
        Args:
            ...
            tool: Tool name performing the analysis (e.g., "ghidra", "frida").
            target: Target binary file path to analyze.
            options: Optional dictionary of analysis options. Defaults to None.
    ...
    def complete_analysis(self, analysis_id: str, results: dict[str, Any]) -> None:
        ...
        Args:
            analysis_id: Analysis identifier string matching an active analysis.
            results: Dictionary of analysis results containing functions,
                vulnerabilities, protections, imports, and strings.
    ...
    def report_vulnerability(self, tool: str, vulnerability: dict[str, Any]) -> None:
        ...
        Args:
            tool: Tool name that discovered the vulnerability.
            vulnerability: Dictionary of vulnerability details including type,
                description, severity, and other relevant fields.
    ...
    def report_protection(self, tool: str, protection: dict[str, Any]) -> None:
        ...
        Args:
            tool: Tool name that detected the protection mechanism.
            protection: Dictionary of protection details including type,
                description, and relevant analysis fields.
    ...
    def report_bypass(self, tool: str, bypass: dict[str, Any]) -> None:
        ...
        Args:
            tool: Tool name that generated the bypass strategy.
            bypass: Dictionary of bypass details including target, type,
    ...
    def update_performance(self, tool: str, metrics: dict[str, Any]) -> None:
        ...
        Args:
            tool: Tool name reporting performance metrics.
            metrics: Dictionary of performance metrics with optional keys
                including memory_mb, cpu_percent, and cache_hit_rate.
    ...
    def get_dashboard_state(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary containing dashboard state with keys including
                timestamp, uptime_seconds, metrics, active_analyses,
                recent_events, event_count, and result_count.
    ...
    def get_metrics_history(self) -> list[dict[str, Any]]:
        ...
        Returns:
            List of historical metrics dictionaries with timestamp and
                metrics data from the metrics_history deque.
    ...
    def _update_metrics_from_event(self, event: DashboardEvent) -> None:
        ...
        Args:
            event: Dashboard event to process for metric updates.
    ...
    def _summarize_results(self, results: dict[str, Any]) -> dict[str, Any]:
        ...
        Args:
            results: Full analysis results dictionary with keys for functions,
                vulnerabilities, protections, imports, and strings.

        Returns:
            Dictionary summarizing analysis results with counts and types
                extracted from the input results.
    ...
    async def _broadcast_event(self, event: DashboardEvent) -> None:
        ...
        Args:
            event: Dashboard event to broadcast to all connected WebSocket clients.
    ...
    def _start_flask_server(self) -> None:
        ...
        def get_state() -> Any:
            ...
            Returns:
                JSON response containing the current dashboard state with
                    timestamp, uptime, metrics, active analyses, and events.
        ...
        def dashboard_view() -> Any:
            ...
            Returns:
                Rendered HTML dashboard template with dashboard state data
                    injected for client-side visualization.
        ...
        def get_events() -> Any:
            ...
            Returns:
                JSON response containing recent dashboard events up to the
                    limit specified in the request query parameter.
        ...
        def get_metrics() -> Any:
            ...
            Returns:
                JSON response containing current analysis metrics including
                    functions analyzed, vulnerabilities, protections, and
                    performance data.
        ...
        def get_metrics_history() -> Any:
            ...
            Returns:
                JSON response containing historical metrics data from the
                    metrics_history collection.
        ...
        def get_active_analyses() -> Any:
            ...
            Returns:
                JSON response containing list of active analyses with their
                    metadata, start times, and status.
        ...
        def get_results(analysis_id: str) -> Any:
            ...
            Args:
                analysis_id: The unique identifier string for the analysis
                    to retrieve results for.

            Returns:
                JSON response containing analysis results if found, or a 404
                    error response if the analysis is not found.
    ...
    def _start_metrics_updater(self) -> None:
        ...
        def update_loop() -> None:
            """Metrics update loop that periodically captures metrics snapshots.
    ...
    async def _broadcast_metrics(self, metrics: dict[str, Any]) -> None:
        ...
        Args:
            metrics: Dictionary of metrics to broadcast to all connected
                WebSocket clients.
...
def create_dashboard(config: dict[str, Any] | None = None) -> RealTimeDashboard:
    ...
    Args:
        config: Optional dashboard configuration dictionary. Defaults to None.

    Returns:
        RealTimeDashboard instance initialized with the provided
            configuration.
