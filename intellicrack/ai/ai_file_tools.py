...
class FileSearchTool:
    ...
    def search_license_files(
        self, search_path: str, custom_patterns: list[str] | None = None
    ) -> dict[str, object]:
...
Purpose: Find licensing-related files for analysis to identify protection mechanisms."""
    ...
    def _process_files_in_directory(
        self, root: str, files: list[str], patterns: list[str], results: dict[str, object]
    ) -> None:
...
class FileReadTool:
    ...
    def __init__(
        self, app_instance: object | None = None, max_file_size: int = 10 * 1024 * 1024
    ) -> None:
    ...
    def read_file_content(
        self, file_path: str, purpose: str = DEFAULT_PURPOSE
    ) -> dict[str, object]:
...
The AI wants to read this file to analyze licensing mechanisms and identify potential bypass locations."""
    ...
    def read_multiple_files(
        self, file_paths: list[str], purpose: str = DEFAULT_PURPOSE
    ) -> dict[str, object]:
...
class AIFileTools:
    ...
    def search_for_license_files(
        self, base_path: str, custom_patterns: list[str] | None = None
    ) -> dict[str, object]:
...
def get_ai_file_tools(
    app_instance: object | None = None, max_file_size: int = 10 * 1024 * 1024
) -> AIFileTools:
