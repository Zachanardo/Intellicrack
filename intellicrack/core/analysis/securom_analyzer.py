...
class SecuROMAnalyzer:
    ...
    ACTIVATION_KEYWORDS = [
        b'ProductActivation', b'ActivateProduct', b'DeactivateProduct',
        b'GetActivationStatus', b'VerifyActivation', b'OnlineActivation',
        b'ActivationLimit', b'ActivationCount', b'MachineIdentifier',
        b'HardwareID', b'HWID', b'DeviceFingerprint'
    ]

    TRIGGER_KEYWORDS = [
        b'ValidateLicense', b'CheckLicenseStatus', b'VerifyProductKey',
        b'ContactActivationServer', b'SendActivationRequest',
        b'CheckActivationValidity', b'ValidateOnline', b'PhoneHome'
    ]

    DISC_AUTH_KEYWORDS = [
        b'DiscSignature', b'DiscFingerprint', b'AuthenticateDisc',
        b'VerifyDiscPresence', b'CheckOriginalDisc', b'ReadDiscSerial',
        b'SCSI', b'CdRom', b'DeviceIoControl'
    ]
    ...
    def _analyze_activation_mechanisms(self, target_path: Path) -> List[ActivationMechanism]:
        ...
        try:
            ...
            mechanisms.append(ActivationMechanism(
        ...
        try:
            ...
            for keyword, pattern, length, format_type in key_patterns:
                if keyword in data:
                    ...
                    keys.append(ProductActivationKey(
        ...
        try:
            ...
            for keyword in self.DISC_AUTH_KEYWORDS:
                ...
                if offset != -1:
                    ...
                    routines.append(DiscAuthRoutine(
        ...
        try:
            ...
            for api in network_apis:
                ...
                if offset != -1:
                    ...
                    mechanisms.append(PhoneHomeMechanism(
    ...
    def _analyze_challenge_response(self, target_path: Path) -> List[ChallengeResponseFlow]:
        ...
        try:
            ...
            if challenge_offset != -1 and response_offset != -1:
                ...
                flows.append(ChallengeResponseFlow(
        ...
        try:
            ...
            for keyword, func_type in validation_keywords:
                ...
                if offset != -1:
                    ...
                    functions.append(LicenseValidationFunction(
                        address=offset,
