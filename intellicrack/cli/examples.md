...
python intellicrack/cli/main.py binary.exe --comprehensive --launch-gui

# Combine with other analysis options
python intellicrack/cli/main.py target.exe \
  --vulnerability-scan \
  --detect-protections \
  --launch-gui
```
...
python intellicrack/cli/main.py suspicious.bin \
  --skip-basic \
  --interactive-hex
```
...
python intellicrack/cli/main.py large_binary.exe \
  --comprehensive \
  --profile-performance
...
python intellicrack/cli/main.py huge_binary.exe \
  --comprehensive \
  --memory-trace
...
```bash
python intellicrack/cli/main.py test_binary.exe \
  --debug-mode \
  --profile-performance \
  --memory-trace \
  --symbolic-execution \
...
python intellicrack/cli/main.py unknown.exe --quick

# If suspicious, do deeper analysis with visual output
python intellicrack/cli/main.py unknown.exe \
  --license-analysis \
  --detect-protections \
  --cfg-analysis \
  --visual-cfg
...
python intellicrack/cli/main.py dev_binary.exe \
  --debug-mode \
  --profile-performance \
  --memory-trace \
  --verbose \
