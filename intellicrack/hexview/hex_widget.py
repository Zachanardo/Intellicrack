...
from PyQt5.QtCore import (
    Qt, QSize, pyqtSignal, QRect, QPoint, QMargins, QTimer,
    QByteArray, QBuffer
)
from PyQt5.QtGui import (
    QColor, QFont, QPainter, QPalette, QTextCursor, QFontMetrics,
    QKeyEvent, QMouseEvent, QPen, QBrush, QResizeEvent, QPaintEvent,
    QTextFormat, QTextCharFormat
)
from PyQt5.QtWidgets import (
    QAbstractScrollArea, QScrollBar, QWidget, QVBoxLayout, QHBoxLayout,
    QLabel, QComboBox, QSpinBox, QToolBar, QAction, QLineEdit,
    QDialog, QDialogButtonBox, QFormLayout, QApplication, QInputDialog,
    QMessageBox, QMenu, QFrame, QSplitter, QCheckBox, QTableWidget,
...
from .hex_highlighter import HexHighlighter, HighlightType, HexHighlight
