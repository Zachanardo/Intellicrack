...
try:
    ...
    from PyQt5.QtWidgets import (
        ...
        QListWidget, QListWidgetItem, QTabWidget, QTextEdit, QProgressBar,
        QDialog, QDialogButtonBox, QMessageBox, QSplitter, QTableWidget,
        QTableWidgetItem, QHeaderView, QSpinBox, QRadioButton, QButtonGroup
    )
