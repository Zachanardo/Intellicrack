...
from PyQt5.QtWidgets import (
    QDialog, QVBoxLayout, QHBoxLayout, QToolBar, QAction, QComboBox,
    QLabel, QStatusBar, QFileDialog, QMessageBox, QShortcut, QSplitter, QApplication,
    QFrame, QListWidget, QListWidgetItem, QMenu, QToolButton, QSizePolicy
)
