...
def _distributed_string_extraction(binary_path: str, config: dict[str, Any]) -> dict[str, Any]:
...
def _distributed_hash_calculation(binary_path: str, config: dict[str, Any]) -> dict[str, Any]:
