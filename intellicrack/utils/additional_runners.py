...
__all__ = [
    "check_adobe_licensex_status", "compute_file_hash", "create_sample_plugins",
    "detect_hardware_dongles", "detect_local_tpm_protection", "get_target_process_pid",
    "load_ai_model", "run_adobe_licensex_manually", "run_analysis",
    "run_autonomous_crack", "run_cfg_analysis", "run_comprehensive_analysis", "run_deep_cfg_analysis",
    "run_deep_license_analysis", "run_detect_packing", "run_external_command", "run_external_tool",
    "run_full_autonomous_mode", "run_generate_patch_suggestions", "run_ghidra_analysis_gui",
