...
This directory contains Certificate Authority (CA) files used by Intellicrack's
SSL/TLS interception module for security research purposes.
...
These files are used by the SSL interceptor module
(`intellicrack/core/network/ssl_interceptor.py`) to:
...
These certificates are for legitimate security research purposes only. Users
must comply with all applicable laws and only use these tools on systems they
own or have explicit permission to test.

## License

These certificate files are part of Intellicrack and are covered under the GNU
General Public License v3.0. See the LICENSE file in the project root for
details.
