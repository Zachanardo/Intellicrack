...
¸   ', b'¸   ', "License check jne"),
                        (b't
¸    ', b'¸   ', "License check je"),
                        (b'', b'é', "Near conditional jump"),  # jne -> jmp
                        (b'', b'é', "Near conditional jump"),  # je -> jmp
                    ]
                        ...
                        if pos != -1:
                            ...
                            if xref_pos != -1:
                                ...
                                for i in range(xref_pos - 1, max(0, xref_pos - 0x100), -1):
                                    ...
                                    if binary_data[i:i+3] == b'UH' or binary_data[i:i+2] == b'U':
                                        func_start = i
                                        break
                                ...
                                if func_start != xref_pos:
                                    # mov eax, 1; ret
                                    binary_data[func_start:func_start+6] = b'¸   Ã'
                                    patches_applied += 1
                    ...
                    if patches_applied > 0:
                        ...
                        for i in md.disasm(bytes(binary_data), 0):
                            if i.mnemonic in ['je', 'jne', 'jz', 'jnz'] and 'license' in i.op_str.lower():
                                ...
                                binary_data[i.address:i.address+i.size] = b'' * i.size
                                patches_applied += 1
