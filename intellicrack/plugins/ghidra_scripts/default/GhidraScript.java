...
public class GhidraScript extends ghidra.app.script.GhidraScript {
    ...
    private void analyzeSymbolTable() throws CancelledException {
        ...
        while (iter.hasNext() && !monitor.isCancelled()) {
            ...
            if (name.contains("license") || name.contains("serial") || 
                name.contains("activation") || name.contains("trial")) {
    ...
    private void analyzeHighFunction(HighFunction highFunc, Function func) {
        ...
        println("Function " + func.getName() + " has " + paramCount + " parameters and " + 
                localVarCount + " local variables");
    }
