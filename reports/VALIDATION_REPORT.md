...
**Date:** 2025-10-19
**Version:** 3.1.0 (with JSON parsing fix)
...
**Cause:** Binwalk v3 binary creates symlinks, which require elevated privileges on Windows
...
The binwalk3 package with JSON parsing fix is **fully validated and ready for publication**:
...
**Recommendation:** Publish to PyPI with current fix. Document Windows extraction limitation in README.
