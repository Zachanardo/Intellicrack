...
autodoc_mock_imports = [
    ...
    # Binary analysis
    'capstone', 'keystone', 'unicorn', 'pwntools',
    ...
    'binaryninja', 'binja',
    # File format parsers
    'pefile', 'pyelftools', 'lief', 'yara',
    # Emulation and virtualization
    'qiling', 'speakeasy', 'vtil',
    # Windows API
    'win32api', 'win32com', 'win32con', 'win32file',
    'win32process', 'win32security', 'pythoncom',
    # Machine learning - EXPANDED LIST
    'torch', 'tensorflow', 'keras', 'sklearn',
    'transformers', 'intel_extension_for_pytorch', 'ipex',
    ...
    # Database
    'sqlalchemy', 'peewee', 'pymongo',
    # CLI and formatting
    'rich', 'click', 'typer', 'colorama', 'termcolor',
    # Serialization
...
latex_documents = [
    (master_doc, 'Intellicrack.tex', f'{project} Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'intellicrack', f'{project} Documentation',
     [author], 1)
]
