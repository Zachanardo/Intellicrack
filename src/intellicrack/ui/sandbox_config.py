...
class SandboxConfigDialog(QDialog):
    ...
    def _set_available(self) -> None:
        ...
        self._status_icon.setStyleSheet("color: #4CAF50; font-size: 16px;")
        self._status_label.setText("Windows Sandbox is available")
        self._status_label.setStyleSheet("color: #4CAF50;")
        self._status_frame.setStyleSheet("background-color: rgba(76, 175, 80, 0.1);")
    ...
    def _set_unavailable(self, reason: str) -> None:
        ...
        self._is_available = False
        self._status_icon.setText("\u2717")
        self._status_icon.setStyleSheet("color: #F44336; font-size: 16px;")
        self._status_label.setText(f"Windows Sandbox unavailable: {reason}")
        self._status_label.setStyleSheet("color: #F44336;")
        self._status_frame.setStyleSheet("background-color: rgba(244, 67, 54, 0.1);")
...
class SandboxMonitorWidget(QFrame):
    ...
    def _setup_ui(self) -> None:
        ...
        self._status_text.setStyleSheet("color: #888;")
        ...
        self._output_text.setStyleSheet(
            ...
            "font-size: 10px; background-color: #1e1e1e; color: #dcdcdc;"
        )
    ...
    def set_running(self, is_running: bool, binary_name: str = "", pid: int | None = None) -> None:
        ...
        if is_running:
            ...
            self._status_text.setStyleSheet("color: #4CAF50;")
