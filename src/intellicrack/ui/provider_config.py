...
class ModelRefreshWorker(QThread):
    ...
    def _fetch_anthropic_models(self) -> tuple[bool, list[str], str]:  # noqa: PLR6301
    ...
    def _load_providers(self) -> None:
        ...
        for display_name, provider_id in providers:
            ...
            widget = ProviderSettingsWidget(
                provider_id, self._registry, self._config_path
            )
...
class ProviderSettingsWidget(QFrame):
    ...
    def _refresh_models(self) -> None:
        ...
        self._refresh_worker = ModelRefreshWorker(
            self._provider_id, api_key, api_base, self
        )
...
class ModelSelectionDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self._info_label.setStyleSheet("color: #888; padding: 10px;")
