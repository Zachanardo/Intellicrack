...
class XRefPanel(QFrame):
    ...
    def _setup_ui(self) -> None:
        ...
        self._xref_display.setStyleSheet("""
            QPlainTextEdit {
                background-color: #1e1e1e;
                color: #d4d4d4;
                border: none;
...
class ToolOutputPanel(QFrame):
    ...
    def _setup_ui(self) -> None:
        ...
        self._address_label.setStyleSheet("color: #9cdcfe;")
