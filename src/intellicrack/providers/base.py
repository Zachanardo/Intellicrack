...
class LLMProviderBase:
    ...
    All provider implementations must inherit from this class and override
    the methods defined here. This ensures a consistent interface
    ...
    def name(self) -> ProviderName:
        ...
        Raises:
            ProviderError: If not overridden by subclass.
        """
        raise ProviderError(
    ...
    async def connect(self, credentials: ProviderCredentials) -> None:
        ...
        """
        raise ProviderError(
            f"{self.__class__.__name__} must override the 'connect' method"
        )
    ...
    async def list_models(self) -> list[ModelInfo]:
        ...
        Raises:
            ProviderError: If not connected or method not implemented.
        """
        raise ProviderError(
            f"{self.__class__.__name__} must override the 'list_models' method"
        )
    ...
    async def chat(
        ...
        """
        raise ProviderError(
            f"{self.__class__.__name__} must override the 'chat' method"
        )
    ...
    async def chat_stream(
        ...
        """
        raise ProviderError(
            f"{self.__class__.__name__} must override the 'chat_stream' method"
        )
        yield ""
    ...
    def _convert_tools_to_provider_format(
        ...
        Raises:
            ProviderError: If not implemented by subclass.
        """
        raise ProviderError(
            f"{self.__class__.__name__} must override '_convert_tools_to_provider_format'"
        )
    ...
    def _convert_messages_to_provider_format(
        ...
        """
        raise ProviderError(
            f"{self.__class__.__name__} must override '_convert_messages_to_provider_format'"
        )
