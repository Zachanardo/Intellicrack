...
class Session:
    ...
    def add_binary(self, binary: BinaryInfo) -> None:
        ...
        if self.active_binary_index < 0:
            self.active_binary_index = 0
...
class SessionStore:
    ...
    def _serialize_binary(self, binary: BinaryInfo) -> dict[str, Any]:
    ...
    def _deserialize_binary(self, data: dict[str, Any]) -> BinaryInfo:
        """Deserialize dictionary to BinaryInfo."""
        from .types import ExportInfo, ImportInfo, SectionInfo
    ...
    def _serialize_tool_state(self, state: ToolState) -> dict[str, Any]:
    ...
    def _deserialize_tool_state(self, data: dict[str, Any]) -> ToolState:
    ...
    def _serialize_patch(self, patch: PatchInfo) -> dict[str, Any]:
    ...
    def _deserialize_patch(self, data: dict[str, Any]) -> PatchInfo:
