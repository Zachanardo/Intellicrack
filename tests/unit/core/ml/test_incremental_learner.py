...
class TestIncrementalLearner:
    ...
    @pytest.fixture
    def learner(self, classifier, tmp_path):
    ...
    def test_add_sample(self, learner, test_binary):
    ...
    def test_add_multiple_samples(self, learner, tmp_path):
    ...
    def test_buffer_persistence(self, learner, test_binary, tmp_path):
    ...
    def test_retrain_incremental(self, learner, tmp_path):
    ...
    def test_buffer_statistics(self, learner, tmp_path):
    ...
    def test_evaluate_sample_quality(self, learner, test_binary):
    ...
    def test_auto_retrain_threshold(self, tmp_path):
    ...
    def test_low_confidence_filtering(self, learner, tmp_path):
