...
class TestR2DecompilationEngineCore:
    ...
    def test_decompile_function_with_valid_address(self, engine):
    ...
    def test_decompile_function_with_license_validation_logic(self, engine):
    ...
    def test_decompile_all_functions_comprehensive(self, engine):
...
class TestR2DecompilationEngineAnalysis:
    ...
    def test_detect_license_patterns_comprehensive(self, engine):
    ...
    def test_detect_vulnerability_patterns_security_analysis(self, engine):
    ...
    def test_calculate_complexity_algorithmic_metrics(self, engine):
    ...
    def test_extract_api_calls_comprehensive_analysis(self, engine):
    ...
    def test_get_string_references_sophisticated_extraction(self, engine):
    ...
    def test_analyze_control_flow_cfg_construction(self, engine):
...
class TestR2DecompilationEngineLicenseAnalysis:
    ...
    def test_analyze_license_functions_comprehensive(self, engine):
    ...
    def test_calculate_license_confidence_sophisticated(self, engine):
    ...
    def test_should_analyze_function_intelligent_filtering(self, engine):
...
class TestR2DecompilationEngineReporting:
    ...
    def test_export_analysis_report_multiple_formats(self, engine_with_analysis):
    ...
    def test_export_analysis_report_with_custom_options(self, engine_with_analysis):
...
class TestR2DecompilationEngineIntegration:
    ...
    def test_cross_module_data_consistency(self, engine):
