...
class TestFirmwareAnalyzer(unittest.TestCase):
    ...
    def test_firmware_analyzer_initialization(self):
    ...
    def test_analyze_firmware_router_comprehensive(self):
    ...
    def test_analyze_firmware_iot_device_detection(self):
    ...
    def test_bootloader_analysis_and_architecture_detection(self):
    ...
    def test_kernel_image_analysis(self):
    ...
    def test_uefi_firmware_analysis(self):
    ...
    def test_entropy_analysis_encrypted_firmware(self):
    ...
    def test_file_extraction_capabilities(self):
    ...
    def test_security_scanning_comprehensive(self):
    ...
    def test_backdoor_detection_capabilities(self):
    ...
    def test_analysis_report_export(self):
    ...
    def test_error_handling_invalid_firmware(self):
    ...
    def test_cleanup_extractions(self):
...
class TestFirmwareAnalyzerIntegration(unittest.TestCase):
    ...
    def test_get_firmware_analyzer_singleton(self):
...
class TestFirmwareAnalyzerEdgeCases(unittest.TestCase):
    ...
    def test_large_firmware_file_handling(self):
    ...
    def test_binary_with_all_security_finding_types(self):
