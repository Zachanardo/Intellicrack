...
class TestROPChainGeneration(IntellicrackTestBase):
    ...
    def _create_gadget_rich_binary(self):
    ...
    def _create_minimal_gadgets_binary(self):
    ...
    def _create_x64_gadgets_binary(self):
    ...
    def _create_system_library_mock(self):
    ...
    def test_rop_chain_basic_generation(self):
    ...
    def test_gadget_identification_comprehensive(self):
    ...
    def test_stack_pivot_chain_construction(self):
    ...
    def test_function_call_chain_construction(self):
    ...
    def test_memory_manipulation_chains(self):
    ...
    def test_aslr_bypass_chain_generation(self):
    ...
    def test_dep_bypass_chain_generation(self):
    ...
    def test_x64_rop_chain_generation(self):
    ...
    def test_chain_length_optimization(self):
    ...
    def test_gadget_conflict_resolution(self):
    ...
    def test_minimal_gadget_handling(self):
    ...
    def test_system_library_integration(self):
    ...
    def test_chain_verification_and_validation(self):
