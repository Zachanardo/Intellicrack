...
class TestThresholdWarnings:
    ...
    def test_duration_warning_threshold(self, performance_monitor: R2PerformanceMonitor, caplog) -> None:
...
class TestRealTimeMonitoring:
    ...
    def test_long_running_operation_detection(self, performance_monitor: R2PerformanceMonitor, caplog) -> None:
