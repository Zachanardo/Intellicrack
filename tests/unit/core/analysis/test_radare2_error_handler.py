...
class TestErrorEvent:
    ...
    def test_error_event_sophisticated_context(self):
...
class TestRecoveryAction:
    ...
    def test_recovery_action_sophisticated_configuration(self):
...
class TestR2ErrorHandlerErrorClassification:
    ...
    def test_low_severity_error_classification(self):
...
class TestR2ErrorHandlerRecoveryStrategy:
    ...
    def test_escalating_recovery_strategies(self):
    ...
    def test_recovery_execution_dispatch(self):
...
class TestR2ErrorHandlerRealWorldScenarios:
    ...
    def test_packed_binary_analysis_errors(self):
    ...
    def test_memory_exhaustion_during_analysis(self):
    ...
    def test_radare2_session_corruption(self):
...
class TestR2ErrorHandlerGlobalFunctions:
    ...
    def test_handle_r2_error_convenience(self):
    ...
    def test_r2_error_context_manager(self):
...
class TestR2ErrorHandlerAdvancedFeatures:
    ...
    def test_custom_recovery_action_registration(self):
    ...
    def test_operation_degradation_detection(self):
    ...
    def test_session_statistics_comprehensive(self):
...
class TestR2ErrorHandlerIntegration:
    ...
    def test_complete_error_handling_workflow(self, temp_binary_file):
    ...
    def test_error_handler_production_readiness(self):
