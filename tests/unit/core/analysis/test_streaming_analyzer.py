...
class TestStreamingDetection:
    ...
    def test_small_file_no_streaming(self, analyzer, small_pe_binary):
    ...
    def test_large_file_auto_streaming(self, analyzer, large_test_file):
    ...
    def test_forced_streaming_small_file(self, analyzer, small_pe_binary):
        """Force streaming mode for small file."""
        results = analyzer.analyze(small_pe_binary, use_streaming=True)
        assert results.get("analysis_status") == "completed"
        assert results.get("streaming_mode") is True

    def test_forced_no_streaming_large_file(self, analyzer, large_test_file):
...
class TestChunkProcessing:
    ...
    def test_read_chunks_basic(self, analyzer, tmp_path):
    ...
    def test_read_chunks_uneven(self, analyzer, tmp_path):
...
class TestHashCalculation:
    ...
    def test_hash_calculation_streaming(self, analyzer, tmp_path):
    ...
    def test_hash_progress_callback(self, analyzer, tmp_path):
...
class TestMemoryMapping:
    ...
    def test_mmap_open_close(self, analyzer, tmp_path):
    ...
    def test_mmap_large_file_access(self, analyzer, large_test_file):
...
class TestProgressTracking:
    ...
    def test_analyze_with_progress_callback(self, analyzer, small_pe_binary):
...
class TestCheckpointing:
    ...
    def test_save_checkpoint(self, analyzer, tmp_path):
    ...
    def test_load_checkpoint(self, analyzer, tmp_path):
    ...
    def test_load_nonexistent_checkpoint(self, analyzer, tmp_path):
    ...
    def test_checkpoint_roundtrip(self, analyzer, small_pe_binary, tmp_path):
...
class TestPatternScanning:
    ...
    def test_pattern_scanning_basic(self, analyzer, tmp_path):
    ...
    def test_pattern_scanning_multiple_matches(self, analyzer, tmp_path):
    ...
    def test_pattern_scanning_with_context(self, analyzer, tmp_path):
...
class TestLicenseStringScanning:
    ...
    def test_license_string_detection(self, analyzer, tmp_path):
    ...
    def test_license_string_patterns(self, analyzer, tmp_path):
...
class TestSectionAnalysis:
    ...
    def test_section_analysis_basic(self, analyzer, tmp_path):
    ...
    def test_section_entropy_calculation(self, analyzer, tmp_path):
    ...
    def test_section_characteristics_classification(self, analyzer, tmp_path):
    ...
    def test_invalid_section_ranges(self, analyzer, tmp_path):
...
class TestStreamingFormatAnalysis:
    ...
    def test_pe_streaming_analysis(self, analyzer, small_pe_binary):
    ...
    def test_format_detection_streaming(self, analyzer, small_pe_binary):
        """Test format detection using streaming."""
        format_name = analyzer._detect_format_streaming(small_pe_binary)

        assert format_name == "PE"

    def test_string_extraction_streaming(self, analyzer, tmp_path):
    ...
    def test_entropy_analysis_streaming(self, analyzer, tmp_path):
