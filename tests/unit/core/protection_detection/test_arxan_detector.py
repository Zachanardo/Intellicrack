...
class TestArxanDetector(unittest.TestCase):
    ...
    def _create_pe_binary(self, arxan_signatures: list[bytes] = None) -> Path:
    ...
    def test_detect_clean_binary(self):
    ...
    def test_detect_arxan_signatures(self):
    ...
    def test_detect_version_5x(self):
    ...
    def test_detect_version_7x(self):
    ...
    def test_string_encryption_detection(self):
    ...
    def test_rasp_indicators_detection(self):
    ...
    def test_white_box_crypto_detection(self):
