...
class TestProtocolFingerprinter(IntellicrackTestBase):
    ...
    def test_initialization_and_configuration(self):
        ...
        assert fingerprinter.config['min_confidence'] > 0, "Invalid default confidence threshold"
        assert fingerprinter.config['max_fingerprints'] > 0, "Invalid max fingerprints setting"
