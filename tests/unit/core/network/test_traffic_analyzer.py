...
class TestNetworkTrafficAnalyzer:
    ...
    @pytest.fixture
    def license_server_simulator(self):
    ...
    def test_pyshark_capture_backend(self, analyzer, license_server_simulator):
    ...
    def test_scapy_capture_backend(self, analyzer, license_server_simulator):
    ...
    def test_license_protocol_detection(self, analyzer):
        ...
        for pattern, protocol_type in test_patterns:
...
class TestTrafficAnalyzerIntegration:
    ...
    def test_complete_license_validation_workflow(self):
        ...
        for step_type, dst_ip, dst_port, payload in workflow_steps:
    ...
    def test_multi_protocol_license_environment(self):
        ...
        for protocol_name, server_ip, port, patterns in protocols:
