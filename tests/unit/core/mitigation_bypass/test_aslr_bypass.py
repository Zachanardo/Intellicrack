...
class TestASLRBypassProductionCapabilities:
    ...
    @pytest.fixture
    def aslr_bypass(self):
        """Create ASLRBypass instance for testing."""
        return ASLRBypass()

    @pytest.fixture
    def test_binary_with_aslr(self, tmp_path):
    ...
    def test_bypass_aslr_info_leak_calculates_multiple_bases(self, aslr_bypass, test_binary_with_aslr, real_process_data):
