...
def test_ssl_interceptor_basic_functionality():
    ...
    try:
        ...
        print("✅ SSL interceptor imported successfully")

        # Test initialization
        interceptor = SSLTLSInterceptor()
        print("✅ SSL interceptor initialized successfully")
        ...
        if cert_pem and key_pem:
            ...
            try:
                ...
                print("✅ Certificate subject validation passed")
                ...
                print("⚠️  Cryptography library not available for detailed validation")

        else:
            print("⚠️  CA certificate generation returned None (cryptography not available)")

        # Test target host management
        print("\n🌐 Testing target host management...")
        initial_hosts = interceptor.get_target_hosts()
        print(f"✅ Initial target hosts: {len(initial_hosts)}")
        ...
        print("✅ Target host addition validated")
...
def test_ssl_interceptor_license_scenarios():
    ...
    try:
        ...
        print("✅ License server targeting validated")
        ...
        print("✅ JSON license response modification validated")
        ...
        print("✅ XML license response modification validated")

        print(f"\n🎉 ALL LICENSE SCENARIO TESTS PASSED")
        return True

    except Exception as e:
        print(f"❌ License scenario test failed: {e}")
        import traceback
        print(traceback.format_exc())
        return False
    ...
    try:
        ...
        if cert_pem and key_pem:
            try:
                ...
                print("✅ Certificate authority capabilities validated")
                ...
                print("✅ Certificate signing capabilities validated")

            except ImportError:
                print("⚠️  Cryptography library not available for detailed security validation")
        ...
        if mitmdump_path:
            print(f"✅ mitmproxy found at: {mitmdump_path}")
        else:
            print("⚠️  mitmproxy not found - SSL interception will be limited")
...
if __name__ == "__main__":
    ...
    if basic_test and license_test and security_test:
        print("✅ ALL TESTS PASSED - SSL interceptor is production-ready for security research")
        ...
        print("❌ SOME TESTS FAILED - Review SSL interceptor implementation")
