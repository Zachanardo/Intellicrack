...
try:
    import _tkinter
    print("OK _tkinter imported successfully", file=sys.stderr)
    ...
    try:
        ...
        root.withdraw()
        root.destroy()
        print("OK tkinter GUI creation successful", file=sys.stderr)
    except Exception as e:
        print(f"FAIL tkinter GUI creation failed: {e}", file=sys.stderr)

except Exception as e:
    print(f"FAIL _tkinter import failed: {e}", file=sys.stderr)
