...
class TestConfigSchemaValidation(IntellicrackTestBase):
    ...
    def setup(self, temp_workspace: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        def real_get_user_config_dir() -> Path:
            """Real implementation returning test config directory."""
            return self.test_config_dir

        monkeypatch.setattr(IntellicrackConfig, '_get_user_config_dir', real_get_user_config_dir)
        self.config = IntellicrackConfig()

    def test_qemu_testing_section_real(self) -> None:
    ...
    def test_font_configuration_section_real(self) -> None:
    ...
    def test_environment_section_real(self) -> None:
    ...
    def test_secrets_section_real(self) -> None:
    ...
    def test_llm_configuration_section_real(self) -> None:
    ...
    def test_cli_configuration_section_real(self) -> None:
    ...
    def test_vm_framework_section_real(self) -> None:
    ...
    def test_runtime_configuration_real(self) -> None:
    ...
    def test_api_cache_configuration_real(self) -> None:
    ...
    def test_security_extended_fields_real(self) -> None:
    ...
    def test_ui_preferences_extended_real(self) -> None:
    ...
    def test_comprehensive_schema_validation_real(self) -> None:
