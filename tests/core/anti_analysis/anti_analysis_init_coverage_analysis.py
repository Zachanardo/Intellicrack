...
try:
    ...
    from tests.core.anti_analysis.test_anti_analysis_init import *
...
def test_functionality() -> bool:
    ...
    try:
        ...
        if vm_result is not None and debugger_result is not None and sandbox_result is not None:
            ...
            print("   FAIL FAIL - Some detection methods returned None")  # type: ignore[unreachable]
            test_results.append(False)
    except Exception as e:
...
def run_test_suite() -> tuple[bool, float]:
