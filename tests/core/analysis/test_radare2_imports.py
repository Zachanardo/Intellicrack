...
class RealSubprocessRunner:
    ...
    def __init__(self) -> None:
        ...
        self.next_returns: list[Any] = []
        self.call_count = 0

    def set_return_sequence(self, returns: list[Any]) -> None:
...
class RealR2ImportAnalyzer:
    ...
    def __init__(self, binary_path: str, radare2_path: str | None = None) -> None:
        ...
        self.imports_data: list[dict[str, Any]] = []
        self.exports_data: list[dict[str, Any]] = []
        self.libraries_data: list[dict[str, Any]] = []
        self.symbols_data: list[dict[str, Any]] = []
        self.relocations_data: list[dict[str, Any]] = []
        self.xrefs_data: list[dict[str, Any]] = []

    def set_test_data(self, data_type: str, data: list[dict[str, Any]]) -> None:
    ...
    def _process_imports(self) -> list[dict[str, Any]]:
    ...
    def _process_exports(self) -> list[dict[str, Any]]:
        """Process export data."""
        return self.exports_data

    def _process_libraries(self) -> list[dict[str, Any]]:
    ...
    def _process_xrefs(self) -> dict[str, list[dict[str, str]]]:
    ...
    def _categorize_api(self, api_name: str | None) -> list[str]:
    ...
    def _categorize_apis(self) -> dict[str, list[str | None]]:
        """Categorize all APIs."""
    ...
    def _detect_suspicious_apis(self) -> list[dict[str, Any]]:
    ...
    def _detect_license_apis(self) -> list[dict[str, Any]]:
    ...
    def _detect_anti_analysis_apis(self) -> list[dict[str, Any]]:
    ...
    def _detect_network_apis(self) -> list[dict[str, Any]]:
        """Detect network APIs."""
    ...
    def _detect_file_apis(self) -> list[dict[str, Any]]:
        """Detect file system APIs."""
        file_apis: list[dict[str, Any]] = []
    ...
    def _detect_registry_apis(self) -> list[dict[str, Any]]:
        ...
        for imp in self.imports_data:
            ...
            if 'Reg' in name:
                operation = 'unknown'
                usage_type: list[str] = ['configuration']
    ...
    def _detect_process_apis(self) -> list[dict[str, Any]]:
        """Detect process APIs."""
    ...
    def _detect_memory_apis(self) -> list[dict[str, Any]]:
        """Detect memory APIs."""
    ...
    def _detect_debug_apis(self) -> list[dict[str, Any]]:
        """Detect debug APIs."""
    ...
    def _assess_risk(self, api_name: str | None) -> str:
    ...
    def _get_api_description(self, api_name: str | None) -> str:
        """Get API description."""
        descriptions = {
        ...
        return descriptions.get(api_name or '', 'Windows API function')
    ...
    def _generate_statistics(self) -> dict[str, Any]:
        ...
        api_categories_count: dict[str, int] = {}
        for cat, apis in categories.items():
            api_categories_count[cat] = len(apis)
        stats['api_categories_count'] = api_categories_count
    ...
    def _generate_security_assessment(self) -> dict[str, Any]:
        ...
        if len(self._detect_anti_analysis_apis()) > 0:
            evasion_techniques.append('anti-debugging')

        # Add threat indicators
        if suspicious_count > 0:
            threat_indicators.append('suspicious API usage')
...
class TestR2ImportExportAnalyzer(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        subprocess.run = self.subprocess_runner.run  # type: ignore[assignment]
    ...
    def test_initialization_with_default_radare2_path(self) -> None:
    ...
    def test_analyze_imports_exports_comprehensive_analysis(self) -> None:
    ...
    def test_pe_format_specific_analysis(self) -> None:
    ...
    def test_suspicious_api_detection_accuracy(self) -> None:
    ...
    def test_crypto_api_analysis_sophistication(self) -> None:
...
class TestProductionValidation(unittest.TestCase):
    ...
    def test_real_world_malware_analysis_capability(self) -> None:
    ...
    def test_commercial_packer_detection_accuracy(self) -> None:
