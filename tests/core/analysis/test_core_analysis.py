...
class TestCoreAnalysis(IntellicrackTestBase):
    ...
    def test_get_machine_type(self) -> None:
    ...
    def test_get_magic_type(self) -> None:
    ...
    def test_get_pe_timestamp(self) -> None:
    ...
    def test_analyze_binary_internal_basic_functionality(self) -> None:
    ...
    def test_analyze_binary_internal_with_flags(self) -> None:
    ...
    def test_analyze_binary_internal_error_handling(self) -> None:
    ...
    def test_enhanced_deep_license_analysis(self) -> None:
    ...
    def test_enhanced_deep_license_analysis_comprehensive(self) -> None:
    ...
    def test_detect_packing_functionality(self) -> None:
    ...
    def test_detect_packing_edge_cases(self) -> None:
    ...
    def test_decrypt_embedded_script_functionality(self) -> None:
    ...
    def test_decrypt_embedded_script_obfuscation_detection(self) -> None:
    ...
    def test_functions_without_pefile(self) -> None:
    ...
    def test_production_ready_output_quality(self) -> None:
    ...
    def test_real_world_binary_analysis_scenarios(self) -> None:
