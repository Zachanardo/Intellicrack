...
class TestRealBinaryPatching:
    ...
    @pytest.mark.skipif(
        not PROJECT_ROOT / "tests" / "fixtures" / "binaries" / "pe" / "legitimate" / "notepadpp.exe".exists(),
    ...
    def test_patch_notepadpp_binary(self, temp_workspace: Path) -> None:
        ...
        source_binary = PROJECT_ROOT / "tests" / "fixtures" / "binaries" / "pe" / "legitimate" / "notepadpp.exe"
