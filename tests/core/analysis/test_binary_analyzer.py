...
class TestBinaryAnalyzer(IntellicrackTestBase):
    ...
    def test_analyze_pe_binary(self) -> None:
    ...
    def test_analyze_elf_binary(self) -> None:
    ...
    def test_detect_format_various_files(self) -> None:
    ...
    def test_calculate_hashes(self) -> None:
    ...
    def test_analyze_entropy(self) -> None:
    ...
    def test_analyze_pe_structure(self) -> None:
    ...
    def test_analyze_elf_structure(self) -> None:
    ...
    def test_error_handling_directory_path(self) -> None:
    ...
    def test_get_segment_flags(self) -> None:
    ...
    def test_analyze_with_different_formats(self) -> None:
    ...
    def test_analyze_archive_format(self) -> None:
    ...
    def test_analyze_dex_format(self) -> None:
    ...
    def test_comprehensive_analysis_workflow(self) -> None:
