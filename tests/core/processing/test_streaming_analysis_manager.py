...
class TestStreamingAnalysisManager:
    ...
    def test_read_chunks_basic(self, tmp_path: Any) -> None:
    ...
    def test_read_chunks_with_overlap(self, tmp_path: Any) -> None:
    ...
    def test_memory_mapped_access(self, tmp_path: Any) -> None:
    ...
    def test_analyze_streaming_basic(self, tmp_path: Any) -> None:
    ...
    def test_analyze_streaming_nonexistent_file(self) -> None:
    ...
    def test_progress_callbacks(self, tmp_path: Any) -> None:
    ...
    def test_calculate_hashes_streaming(self, tmp_path: Any) -> None:
    ...
    def test_scan_for_patterns_streaming(self, tmp_path: Any) -> None:
    ...
    def test_analyze_section_streaming(self, tmp_path: Any) -> None:
    ...
    def test_should_use_streaming(self, tmp_path: Any) -> None:
    ...
    def test_checkpoint_save_load(self, tmp_path: Any) -> None:
    ...
    def test_large_file_simulation(self, tmp_path: Any) -> None:
