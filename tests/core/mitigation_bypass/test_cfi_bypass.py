...
class TestCFIBypassCore:
    ...
    @pytest.fixture
    def cfi_bypass(self) -> Any:
        """Create CFIBypass instance for testing."""
        return CFIBypass()

    @pytest.fixture
    def sample_pe_with_cfg(self) -> Any:
    ...
    @pytest.fixture
    def sample_elf_with_cet(self) -> Any:
    ...
    def test_analyze_cfi_protection_with_cfg(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_analyze_cfi_protection_with_cet(self, cfi_bypass: Any, sample_elf_with_cet: Any) -> None:
    ...
    def test_analyze_unprotected_binary(self, cfi_bypass: Any) -> None:
    ...
    def test_generate_bypass_payload_for_cfg(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_generate_bypass_payload_with_rop(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_find_rop_gadgets(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_find_jop_gadgets(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_get_available_bypass_methods(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_vtable_hijacking_bypass(self, cfi_bypass: Any) -> None:
    ...
    def test_shadow_stack_bypass(self, cfi_bypass: Any, sample_elf_with_cet: Any) -> None:
    ...
    def test_indirect_call_analysis(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_indirect_branch_analysis(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_cfi_marker_detection(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_bypass_target_discovery(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_legitimate_target_finding(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_function_start_detection(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_vtable_entry_detection(self, cfi_bypass: Any) -> None:
    ...
    def test_function_pointer_detection(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_exported_function_detection(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
        """Test detection of exported functions."""
        exports = cfi_bypass._find_exported_functions(sample_pe_with_cfg)

        assert isinstance(exports, list)

    def test_gadget_usefulness_evaluation(self, cfi_bypass: Any) -> None:
    ...
    def test_jop_chain_building(self, cfi_bypass: Any) -> None:
    ...
    def test_addressing_mode_decoding(self, cfi_bypass: Any) -> None:
    ...
    def test_branch_protection_checking(self, cfi_bypass: Any) -> None:
    ...
    def test_branch_payload_generation(self, cfi_bypass: Any) -> None:
    ...
    def test_fake_vtable_generation(self, cfi_bypass: Any) -> None:
    ...
    def test_rop_chain_building(self, cfi_bypass: Any) -> None:
    ...
    def test_bypass_difficulty_calculation(self, cfi_bypass: Any) -> None:
    ...
    def test_gadget_description(self, cfi_bypass: Any) -> None:
    ...
    def test_error_handling_invalid_file(self, cfi_bypass: Any) -> None:
    ...
    def test_error_handling_corrupt_binary(self, cfi_bypass: Any) -> None:
    ...
    def test_payload_generation_without_analysis(self, cfi_bypass: Any) -> None:
    ...
    def test_multi_technique_bypass(self, cfi_bypass: Any, sample_pe_with_cfg: Any) -> None:
    ...
    def test_cfi_bypass_with_aslr(self, cfi_bypass: Any) -> None:
    ...
    def test_performance_large_binary(self, cfi_bypass: Any) -> None:
    ...
    def test_concurrent_analysis(self, cfi_bypass: Any) -> None:
...
class TestCFIBypassIntegration:
    ...
    def test_integration_with_binary_analyzer(self, cfi_bypass: Any) -> None:
    ...
    def test_real_world_cfg_bypass(self, cfi_bypass: Any) -> None:
    ...
    def test_cet_shadow_stack_bypass(self, cfi_bypass: Any) -> None:
...
class TestCFIBypassEdgeCases:
    ...
    def test_empty_file_handling(self, cfi_bypass: Any) -> None:
    ...
    def test_text_file_handling(self, cfi_bypass: Any) -> None:
    ...
    def test_permission_denied_handling(self, cfi_bypass: Any) -> None:
    ...
    def test_invalid_technique_handling(self, cfi_bypass: Any) -> None:
    ...
    def test_null_bytes_in_payload(self, cfi_bypass: Any) -> None:
    ...
    def test_extremely_small_binary(self, cfi_bypass: Any) -> None:
    ...
    def test_mixed_architecture_handling(self, cfi_bypass: Any) -> None:
    ...
    def test_unicode_path_handling(self, cfi_bypass: Any) -> None:
    ...
    def test_network_path_handling(self, cfi_bypass: Any) -> None:
    ...
    def test_symbolic_link_handling(self, cfi_bypass: Any) -> None:
