...
class TestCFIBypassProduction:
    ...
    @pytest.fixture
    def windows_cfg_binary(self) -> Any:
    ...
    def test_cfi_bypass_initialization(self) -> None:
    ...
    def test_cfi_techniques_available(self) -> None:
    ...
    def test_analyze_cfi_protection(self, windows_cfg_binary: Any) -> None:
    ...
    def test_generate_bypass_payload(self, windows_cfg_binary: Any) -> None:
    ...
    def test_find_rop_gadgets(self, windows_cfg_binary: Any) -> None:
    ...
    def test_find_jop_gadgets(self, windows_cfg_binary: Any) -> None:
    ...
    def test_get_recommended_technique(self) -> None:
    ...
    def test_cfi_bypass_vtable_hijacking(self) -> None:
    ...
    def test_cfi_bypass_return_oriented(self) -> None:
    ...
    def test_cfi_bypass_indirect_branches(self) -> None:
    ...
    def test_cfi_bypass_error_handling(self) -> None:
    ...
    def test_cfi_bypass_with_multiple_techniques(self, windows_cfg_binary: Any) -> None:
    ...
    def test_cfi_markers_detection(self, windows_cfg_binary: Any) -> None:
    ...
    def test_bypass_difficulty_calculation(self) -> None:
