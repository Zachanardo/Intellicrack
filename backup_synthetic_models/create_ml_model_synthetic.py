...
def generate_synthetic_data():
    ...
    # Log distribution
    logger.info("Generated vulnerability distribution:")
    for i, vuln_type in enumerate(VULNERABILITY_TYPES):
        count = np.sum(y == i)
...
def plot_feature_importances(model, feature_names, top_n=20):
    ...
    logger.info("Feature importance plot saved to models/feature_importances.png")
    ...
    try:
        ...
        try:
            ...
            if os.path.exists(config_path):
                ...
                config["ml_model_path"] = os.path.abspath(os.path.join(models_dir, "ml_vulnerability_model.joblib"))
